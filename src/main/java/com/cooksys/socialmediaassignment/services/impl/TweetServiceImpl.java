...
//        userRepository.saveAndFlush(user);
    ...
    private Long _authorizeCredential(Credentials credentials) {
        Optional<User> userOptional = userRepository.findUserByCredentialsUsernameAndDeletedFalse(credentials.getUsername());
    ...
    private User _getUserByUsername(String username) {
        Optional<User> userOptional = userRepository.findUserByCredentialsUsernameAndDeletedFalse(username);
